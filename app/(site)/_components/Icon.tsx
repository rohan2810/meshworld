...
export function Icon({ className, children }: IconProps) {
  return (
    <div
      className={cn(
        'flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-cy/10 to-vi/10 text-cy',
        className
      )}
    >
      {children}
...
export const MultimodalIcon = ({ className }: { className?: string }) => (
  <svg
    className={cn('h-6 w-6', className)}
    fill="none"
    viewBox="0 0 24 24"
...
export const ReflectionIcon = ({ className }: { className?: string }) => (
  <svg
    className={cn('h-6 w-6', className)}
    fill="none"
    viewBox="0 0 24 24"
